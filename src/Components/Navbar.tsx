...
function Navbar() {
    return(
        <div className="navbar items-center flex justify-between bg-[#121212] h-[80px] fixed top-[0px] w-[100%] z-[100]">
