    ...
    return(
        <div className="aboutme mt-[96px]">
            ...
            <div className="aboutme-section flex mt-[40px] ml-[130px]">
                ...
                <div className="aboutme-font w-[450px] h-[494px] leading-[190%] text-[#959595] text-justify ml-[240px] mt-[59px]">
